...
const HomeCoverSection =  ({blogs}) => {
  ...
  return (
    ...
    <div className='w-full'>
        <article className='flex flex-col items-start justify-end mx-5 sm:mx-10 relative h-[60vh] sm:h-[85vh] w-[80vw]'>
            <div className='absolute top-0 left-0 bottom-0 right-0 h-full w-[100%] rounded-3xl z-0 ' />
